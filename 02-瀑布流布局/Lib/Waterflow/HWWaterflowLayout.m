...
/** 每一行的最大列数 */
static const int HWDefaultMaxColumns = 3;
/** 每一行的间距 */
static const CGFloat HWDefaultRowMargin = 10;
/** 每一列的间距 */
static const CGFloat HWDefaultColumnMargin = 10;
/** 上下左右的间距 */
static const UIEdgeInsets HWDefaultInsets = {10, 10, 10, 10};

@interface HWWaterflowLayout()
/** 存放每一列的最大Y值(整体高度) */
@property (nonatomic, strong) NSMutableArray *maxYs;
@property (nonatomic, strong) NSMutableArray *attrsArray;
@end

@implementation HWWaterflowLayout
